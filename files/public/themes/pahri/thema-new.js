(() => {
    ...
    const injectDockStudio = async () => {
        ...
        studio.innerHTML = `
            ...
            <div class="checkbox pahri-checkbox"><label><input type="hidden" name="maintenance_enabled" value="0"><input class="pahri-checkbox-input" type="checkbox" name="maintenance_enabled" value="1" ${maintenance.enabled ? 'checked' : ''}><span class="pahri-checkbox-ui" aria-hidden="true"></span><span class="pahri-checkbox-label">Aktifkan maintenance mode — hanya user ID 1 boleh akses</span></label></div>
            ...
            <div class="checkbox pahri-checkbox"><label><input type="hidden" name="security_drill_enabled" value="0"><input class="pahri-checkbox-input" type="checkbox" name="security_drill_enabled" value="1" ${drill.enabled ? 'checked' : ''}><span class="pahri-checkbox-ui" aria-hidden="true"></span><span class="pahri-checkbox-label">Aktifkan tema hancur / fake hacking visual</span></label></div>
            ...
            <div class="checkbox pahri-checkbox"><label><input type="hidden" name="dock_active" value="0"><input class="pahri-checkbox-input" type="checkbox" name="dock_active" value="1" ${dock.active ? 'checked' : ''}><span class="pahri-checkbox-ui" aria-hidden="true"></span><span class="pahri-checkbox-label">Aktifkan floating Nexus Dock</span></label></div>
